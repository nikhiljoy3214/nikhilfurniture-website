...
const SEARCHABLE_ITEMS = [
  { name: 'Logo, Favicon & Socials (General Settings)', category: 'Settings', description: 'Upload store logo, select favicon, configure Facebook/Instagram links, operating hours, and footer description text', path: '/admin/settings' },
  { name: 'Header Styling & Opacity (General Settings)', category: 'Settings', description: 'Customize top header navigation opacity, transparency, background color, and text color configurations', path: '/admin/settings' },
  { name: 'Announcement Bar (General Settings)', category: 'Settings', description: 'Toggle top banner announcement text, background color, text color, View Offers button text, and redirect links', path: '/admin/settings' },
  { name: 'WhatsApp Chat Widget (General Settings)', category: 'Settings', description: 'Configure floating green WhatsApp helper widget number, default chat text, and position placement', path: '/admin/settings' },
  { name: 'SEO Metadata Manager', category: 'Site Settings', description: 'Configure search engine meta titles, page descriptions, meta keywords, open graph OG images, sitemap, and robots.txt rules', path: '/admin/site-management', tab: 'seo' },
  { name: 'Website Analytics Dashboard', category: 'Site Settings', description: 'Analyze visitor stats, WhatsApp chat clicks, direct calls, and daily page views charts', path: '/admin/site-management', tab: 'analytics' },
  { name: 'System Database Health Check', category: 'Site Settings', description: 'Check PostgreSQL database status, bucket storage usage, media library file sizes, and top 5 largest files', path: '/admin/site-management', tab: 'health' },
  { name: 'Maintenance Mode Toggle', category: 'Security', description: 'Put website offline, edit custom maintenance message banners, and estimated return date timer', path: '/admin/site-management', tab: 'security' },
  { name: 'Database Backup & JSON/CSV Export', category: 'Settings', description: 'Export products catalog table to JSON/CSV files, backup settings, or import configuration sheets', path: '/admin/site-management', tab: 'backup' },
  { name: 'System Activity Logs', category: 'Security', description: 'Track admin actions, modifications, modules changed, and timestamps', path: '/admin/site-management', tab: 'logs' },
  { name: 'General Information & Domain', category: 'Site Settings', description: 'View application version, build dates, domain hosts, Supabase project IDs, and PostgreSQL engine', path: '/admin/site-management', tab: 'general' },
  { name: 'Homepage Content Builder', category: 'Content Sections', description: 'Arrange homepage hero banners, main headings, promotional CTA overlays, and testimonial slider cards', path: '/admin/homepage-builder' },
  { name: 'About Page Editor', category: 'Content Pages', description: 'Edit brand story description, history timeline points, and signature details', path: '/admin/content/about' },
  { name: 'Contact Info & Showroom Maps', category: 'Content Pages', description: 'Update showroom phone numbers, operating hours, and Google maps link location', path: '/admin/content/contact' },
  { name: 'FAQ Page Manager', category: 'Content Pages', description: 'Add, update, or reorder customer frequently asked questions lists', path: '/admin/content/faq' },
  { name: 'Testimonials Review Manager', category: 'Content Pages', description: 'Manage review cards, star ratings, display statuses, and custom client feedback', path: '/admin/content/testimonials' },
  { name: 'Products Catalog', category: 'Catalog', description: 'View full product catalog table, edit prices, wood types, descriptions, attributes, and combinations', path: '/admin/products' },
  { name: 'Categories Manager', category: 'Catalog', description: 'Sort, update, delete, or create product classification categories and dynamic submenus', path: '/admin/categories' },
  { name: 'Media Library Manager', category: 'Media', description: 'Upload, delete, and organize product showcase pictures, thumbnails, and asset folders', path: '/admin/media-library' },
];
